...
import FictiveMunicipalityPage from "./pages/verifiers/fictive-municipality/page";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/verifiers/fictive-municipality/*" element={<FictiveMunicipalityPage />} />
