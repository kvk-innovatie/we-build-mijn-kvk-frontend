...
const translations = {
  nl: {
    ...
    step1Desc: "Scan the QR code with your NP Wallet to securely share your identity attributes.",
    ...
    verifyDesc:
      "Use your NP Wallet (personal) to complete the KYC process in less than a minute.",
    walletLabel: "Verify with NP Wallet",
    ...
    reviewDesc:
      "Please review the information received from your NP Wallet. By submitting, you authorise Deutsche Bank to use this data for customer identification.",
