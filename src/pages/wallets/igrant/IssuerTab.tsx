    ...
    <div className="mt-10 px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900">Issuer</h1>
            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
              <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-gray-50">
                  <tr>
                    <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Credential</th>
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Issued to</th>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {issuedAttestations.map((attestation, index) => (
                    <tr key={index}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{attestation.issuedTo}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{attestation.valid}</td>
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="#" className="text-indigo-600 hover:text-indigo-900">
                          View<span className="sr-only">, {attestation.credential}</span>
                        </a>
                      </td>
                    </tr>
                  ))}
